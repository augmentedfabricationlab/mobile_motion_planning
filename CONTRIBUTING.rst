...
1. Fork `the repository <https://github.com/augmentedfabricationlab/mobile_motion_planning>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/mobile_motion_planning/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/mobile_motion_planning/issues>`_. If you are proposing a feature:
